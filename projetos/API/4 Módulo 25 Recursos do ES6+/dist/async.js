...
var promiseParametros = function promiseParametros(login, senha) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          // isso e pra dar parametros pra uma promise:
          promiseParametros('gabs-z@gmail.com', 123456).then(function (resultado) {
        ...
        case 5:
          ...
          console.log("".concat(resultado, "1"));
          _context.next = 12;
          break;
        case 9:
          _context.prev = 9;
